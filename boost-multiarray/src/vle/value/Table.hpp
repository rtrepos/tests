...
public:
    ...
    Table(const index& width, const index& height)
        : m_extent(), m_value(boost::extents[width][height]), m_width(width),
        m_height(height)
    {}
    ...
    Table(const Table& value)
        : Value(value), m_extent(), m_value(value.m_value),
        m_width(value.m_width), m_height(value.m_height)
    {}
...
private:
    TableValue::extent_gen m_extent;
    TableValue      m_value;
    index           m_width;
    index           m_height;
};
